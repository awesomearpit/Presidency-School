...
class PdfBody extends Component {
  constructor(props) {
    super(props);
    this.state = {
      leadsInfo: {},
                  ...
                  <div className="row body-view no-margin">
                    ...
                    >
                      <table className="table table-bordered">
                        ...
                        <tbody>
                          <tr>
                            <td scope="row">{ dataFields? moment(dataFields[5].CustomObjectFormProperties.FieldProperties.FormMetaData[1].Value).format("DD/MM/YYYY"):null} - { dataFields? moment(dataFields[5].CustomObjectFormProperties.FieldProperties.FormMetaData[2].Value).format("DD/MM/YYYY"):null}</td>
                            <td>{leadsInfo.mx_Name_of_the_School_and_Grade_Last_Studied_in}</td>
                            <td>{dataFields? dataFields[5].CustomObjectFormProperties.FieldProperties.FormMetaData[3].Value:null}</td>
                            <td>{dataFields? dataFields[5].CustomObjectFormProperties.FieldProperties.FormMetaData[4].Value:null}</td>
                            <td>{dataFields? dataFields[5].CustomObjectFormProperties.FieldProperties.FormMetaData[5].Value:null}</td>
                            <td>{dataFields? dataFields[5].CustomObjectFormProperties.FieldProperties.FormMetaData[6].Value:null}</td>
                            <td>{dataFields? dataFields[5].CustomObjectFormProperties.FieldProperties.FormMetaData[7].Value:null}</td>
                          </tr>
                          <tr>
                            <td scope="row">{ dataFields? moment(dataFields[6].CustomObjectFormProperties.FieldProperties.FormMetaData[1].Value).format("DD/MM/YYYY"):null} - { dataFields? moment(dataFields[6].CustomObjectFormProperties.FieldProperties.FormMetaData[2].Value).format("DD/MM/YYYY"):null}</td>
                            <td>{leadsInfo.mx_Name_of_the_School_and_Grade_Last_Studied_in}</td>
                            <td>{dataFields? dataFields[6].CustomObjectFormProperties.FieldProperties.FormMetaData[3].Value:null}</td>
                            <td>{dataFields? dataFields[6].CustomObjectFormProperties.FieldProperties.FormMetaData[4].Value:null}</td>
                            <td>{dataFields? dataFields[6].CustomObjectFormProperties.FieldProperties.FormMetaData[5].Value:null}</td>
                            <td>{dataFields? dataFields[6].CustomObjectFormProperties.FieldProperties.FormMetaData[6].Value:null}</td>
                            <td>{dataFields? dataFields[6].CustomObjectFormProperties.FieldProperties.FormMetaData[7].Value:null}</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                    ...
                    <div className="col-md-12 dob">
                      ...
                      {!dataFields ? (
                        <>
                          <div className="checkBox"></div>&nbsp;Yes &nbsp;
                          <div className="checkBox"></div>&nbsp;No&nbsp;
                        </>
                      ) : (
                        <>
                          {dataFields[10].CustomObjectFormProperties.FieldProperties
                            .FormMetaData[0].Value ? (
                            <>
                              {dataFields[10].CustomObjectFormProperties.FieldProperties
                                .FormMetaData[0].Value === "Yes" ? (
                                <>
                                  <div className="checkBox">
                                    <i className="fa fa-check" aria-hidden="true"></i>
                                  </div>&nbsp;
                                  Yes&nbsp;<div className="checkBox"></div>&nbsp;No&nbsp;
                                </>
                              ) : (
                                <>
                                  <div className="checkBox"></div>&nbsp;Yes&nbsp;
                    ...
                    <div className="col-md-12 dob">School Staff ( PGI)&nbsp;&nbsp;&nbsp;
                      {!dataFields ? (
                        <>
                          <div className="checkBox"></div>&nbsp;Yes &nbsp;
                          <div className="checkBox"></div>&nbsp;No&nbsp;
                        ...
                        <>
                          {dataFields[11].CustomObjectFormProperties.FieldProperties
                            .FormMetaData[0].Value ? (
                            <>
                              {dataFields[11].CustomObjectFormProperties.FieldProperties
                                .FormMetaData[0].Value === "Yes" ? (
...
export default withRouter(PdfBody);
